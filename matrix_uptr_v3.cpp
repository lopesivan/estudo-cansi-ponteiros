// g++ -std=c++17 -O2 -Wall -Wextra -pedantic matrix_uptr_v3.cpp -o app
...
int main()
{
    ...
    auto matriz = make_matrix<float> (rows, cols);
    if (!matriz)
    {
    ...
    float* base = matriz.get()[0];           // primeiro elemento real
